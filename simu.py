...
if st.session_state.run:
            ...
            'encoding': {
                ...
                'color': {
                    ...
                    'scale': {
                        ...
                        'range': [c1, c2, 'black']  # Käyttää valittuja värejä
                    }
                },
                'strokeDash': {
                    'field': 'Aalto',
                    ...
                    'scale': {
                        'domain': ['Aalto 1', 'Aalto 2', 'Summa'],
                        'range': [[0,0], [0,0], [5,5]]  # Summa on katkoviiva
                    }
                }
            },
            'height': 450
    ...
    # Näytetään peruskuvaaja myös tauolla, jotta sivu ei ole tyhjä
    y1_s = np.sin(v1 * t)
    y2_s = np.sin(v2 * t)
